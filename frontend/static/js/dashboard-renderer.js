...
function renderEditProcessButton(uid) {
    return `<a href="process?uid=` + uid + `"><i id="PenIcon" class="fas fa-edit"></i></a>`;
}
...
function renderEditComponentButton(uid) {
    return `<a href="component?uid=` + uid + `"><i id="PenIcon" class="fas fa-edit"></i></a>`;
}
...
function renderDeleteProcessButton(uid) {
    return `<div onclick="deleteProcess('` + uid + `')"><i id="TrashIcon" class="fas fa-trash"></i></div>`;
}
...
function renderDeleteComponentButton(uid) {
    return `<div onclick="deleteComponent('` + uid + `')"><i id="TrashIcon" class="fas fa-trash"></i></div>`;
}
